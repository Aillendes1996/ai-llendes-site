...
const translations = {
  ...
  fr: {
    ...
    chat_3: "Super — lien vers le calendrier ci-dessous 📅",
    ...
    card2_p: "Des séquences humaines qui qualifient, répondent aux FAQ et lèvent les objections—sans suivi manuel.",
    card3_h: "📅 Réservation automatique",
    card3_p: "Envoie les prospects qualifiés dans votre agenda avec rappels et replanifications automatiques.",
    card4_h: "⏳ Gain de temps",
    card4_p: "Nous automatisons les tâches répétitives pour que vous puissiez conclure—plus de ping-pong d’emails.",
    card5_h: "♻️ Relancer les prospects perdus",
    card5_p: "Des relances intelligentes réengagent les prospects inactifs ou perdus et ramènent des revenus.",
    card6_h: "🔌 Votre stack",
    card6_p: "Google/Outlook, HubSpot/Salesforce/Pipedrive, Meta/Google Ads, Typeform, Zapier—plug and play.",
    ...
    commit2_p: "Nous intégrons votre CRM, vos publicités et votre agenda—tout est prêt pour vous.",
    commit3_h: "Priorité au revenu",
    commit3_p: "Optimisé pour des appels générateurs de revenu, pas seulement des réponses.",
    commit4_h: "Confidentialité & conformité",
    commit4_p: "Messages conformes avec opt-out clair et contrôle des données.",

    stat_1: "Temps de réponse moyen",
    stat_2: "Toujours actif",
    stat_3: "Engagement hors horaires",
    stat_4: "Délai de réservation (minutes)",

    faq_title: "FAQ",
    faq1_q: "À quelle vitesse répondez-vous vraiment ?",
    faq1_a: "Nous visons 15–60 secondes entre la capture et le premier message, 24/7. La plupart des clients voient ~30 secondes.",
    faq2_q: "Est-ce compatible avec mes outils existants ?",
    faq2_a: "Oui—CRMs, agendas, formulaires et plateformes publicitaires. Avec un API ou Zapier, on peut se connecter.",
    faq3_q: "Comment gérez-vous la conformité et les désabonnements ?",
    faq3_a: "Nous incluons la capture du consentement, des flux d’opt-out clairs et respectons les règles régionales.",
    faq4_q: "À quoi ressemble l’onboarding ?",
    faq4_a: "Appel stratégique, workflows définis, intégrations connectées, séquences lancées—en 7–10 jours typiquement.",
    ...
    book_p: "Choisissez un moment qui vous convient, ou laissez vos infos et nous confirmerons par SMS/email.",
    book_left_h: "Lien direct vers le calendrier",
    book_left_p: "Déjà prêt ? Allez directement au calendrier.",
